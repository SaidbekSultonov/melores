 ...
 */
class TradeCompanyController extends Controller
{
    ...
    public function actionDelete($id)
    {
        ...
        try {
            $companyDistrict = TradeCompanyDistrict::find()->where(['company_id' => $id])->all();
            ...
            $companyFiles = TradeCompanyFiles::find()->where(['company_id' => $id])->all();
            ...
            $companyServiceType = TradeCompanyServicesType::find()->where(['company_id' => $id])->all();
            ...
            $companyStatistics = TradeServiceStatistics::find()->where(['type' => 'company', 'button_id' => $id])->all();
    ...
    {
        if (($model = TradeCompany::findOne($id)) !== null) {
            return $model;
        }
