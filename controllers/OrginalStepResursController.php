...
use Yii;
use app\models\OrginalStepResurs;
...
/**
 * OrginalStepResursController implements the CRUD actions for OrginalStepResurs model.
 */
class OrginalStepResursController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all OrginalStepResurs models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => OrginalStepResurs::find()->orderBy(['id' => SORT_ASC]),
        ]);
    ...
    /**
     * Displays a single OrginalStepResurs model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new OrginalStepResurs model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new OrginalStepResurs();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            switch($model->type){
                case "photo":
                    ...
                    if ($model->file_id->extension == "jpg" || $model->file_id->extension == "png" || $model->file_id->extension == "jpeg"){
                        ...
                        $selectVideo = OrginalStepResurs::find()->where(['file_id' => $model->file_id])->one();
                ...
                case "text":
                    if (!empty($model->caption)) {
                        ...
                        $selectVideo = OrginalStepResurs::find()->where(['file_id' => $model->caption])->one();
            ...
            return $this->redirect(['/index.php/orginal-step-resurs/view', 'id' => $model->id]);
        }
    ...
    /**
     * Updates an existing OrginalStepResurs model.
    ...
    /**
     * Deletes an existing OrginalStepResurs model.
    ...
    /**
     * Finds the OrginalStepResurs model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return OrginalStepResurs the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = OrginalStepResurs::findOne($id)) !== null) {
            return $model;
        }
