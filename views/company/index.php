        ...
        <?php if (!empty($model)): ?>
            <?php foreach ($model as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        <a href="/index.php/company/view?id=<?php echo $value->id ?>" id="delete-services" class="glyphicon glyphicon-cog"></a>
                        ...
                        <a href="/index.php/company/delete?id=<?php echo $value->id ?>" class="glyphicon glyphicon-trash delete-services"></a>
                    </td>
                </tr>
            <?php endforeach ?>
        <?php else: ?>
...
<script>
    ...
    $(document).on('click','.save-services',function(){
        ...
        $.ajax({
            url: '/index.php/company/save-services',
            dataType: 'json',
            type: 'GET',
            data:{
    ...
    $(document).on('click','.update-save-services',function(){
        ...
        $.ajax({
            url: '/index.php/company/update-save',
            dataType: 'json',
            type: 'GET',
            data:{
                services_uz: services_uz,
