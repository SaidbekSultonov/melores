            ...
            <?php foreach ($model as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/index.php/services-types/delete?id=<?php echo $value->id ?>" id="delete-services" class="glyphicon glyphicon-trash"></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else: ?>
...
<script>
    $(function(){
        ...
        $('select').change('select2:select', function (e) {
            ...
            $.ajax({
                url: '/index.php/services-types/order',
                dataType: 'json',
                type: 'GET',
                data: {
                    id: id,
    ...
    $(document).on('click','#open-services-types',function(){
        $.ajax({
            url: '/index.php/services-types/create',
            dataType: 'json',
            type: 'GET',
            success: function (response) {
                if (response.status == 'success') {
    ...
    $(document).on('click','.save-services-types',function(){
        ...
        $.ajax({
            url: '/index.php/services-types/save-services-types',
            dataType: 'json',
            type: 'GET',
            data:{
    ...
    $(document).on('click','#update-services',function(){
        ...
        $.ajax({
            url: '/index.php/services-types/update',
            dataType: 'json',
            type: 'GET',
            data: {id: id},
            success: function (response) {
    ...
    $(document).on('click','.update-save-services',function(){
        ...
        $.ajax({
            url: '/index.php/services-types/update-save',
            dataType: 'json',
            type: 'GET',
            data:{
                services_uz: services_uz,
