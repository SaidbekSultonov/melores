...
<div class="company-view">
    <div class="row">
        ...
        <div class="col-md-6">
            <h2>
                <a class="btn btn-success pull-right" href="/index.php/sale-company-files/create?id=<?php echo $model->id ?>">Ma'lumot qo'shish</a>
            </h2>
        </div>
    </div>
        ...
        <?php if (!empty($files)): ?>
            <?php $i = 1; foreach ($files as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        ...
                        if (!is_null($value->file_id)){
                            ...
                            if(isset($imageFileId) and $value->type != "text") {
                                $file = 'https://api.telegram.org/file/bot1950637880:AAEzc1RhYpLe5t1d8zatop1JdP0MaNvpQRY/'.$imageFileId->result->file_path;
                            }
                    ...
                    <td>
                        <a class="del" href="/index.php/sale-company-files/delete?id=<?php echo $value->id ?>&com=<?php echo $model->id ?>">
