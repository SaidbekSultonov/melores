...
<div class="sale-company-files-form">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?php
            $categories = \app\models\SaleServicesType::find()->all();
        ...
        <div class="col-md-6">
            ...
            $categories = \app\models\SaleDistrict::find()->all();
            $listData=ArrayHelper::map($categories,'id', 'title_uz');
...
<script>
    $(function(){
        ...
        $(document).on('change','#salecompanyfiles-type',function(){
            let type = $(this).val()
