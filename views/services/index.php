            ...
            <?php foreach ($model as $key => $value): ?>
                <tr>
                    ...
                    <td>
                       ...
                       <a href="/index.php/services/delete?id=<?php echo $value->id; ?>" id="delete-services" class="glyphicon glyphicon-trash"></a>         
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else: ?>
...
<script>
    ...
    $(document).on('click','.save-services',function(){
        ...
        $.ajax({
            url: '/index.php/services/save-services',
            dataType: 'json',
            type: 'GET',
            data:{
    ...
    $(document).on('click','.update-save-services',function(){
        ...
        $.ajax({
            url: '/index.php/services/update-save',
            dataType: 'json',
            type: 'GET',
            data:{
                services_uz: services_uz,
