        ...
        <div class="col-md-6">
            <h2>
                <a class="btn btn-success pull-right"
                   href="/index.php/trade-company-files/create?id=<?php echo $model->id ?>">Ma'lumot qo'shish</a>
            </h2>
        </div>
    </div>
        ...
        <?php if (!empty($files)): ?>
            ...
            foreach ($files as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        <?php if (isset($value->service->title_uz)): ?>
                            <span class="label label-primary">
                                <?php echo $value->service->title_uz ?>
                            </span>
                        <?php else: ?>
                    ...
                    <td>
                        ...
                        if (!is_null($value->file_id)) {
                            ...
                            if (isset($imageFileId) && $imageFileId->ok !== false && $value->type !== "text") {
                                $file = 'https://api.telegram.org/file/bot1809516633:AAEF1HkG0udnOAkqWaeHelAjcb0SUi0xGDI/' . $imageFileId->result->file_path;
                            }
                    ...
                    <td>
                        <a class="del"
                           href="/index.php/trade-company-files/delete?id=<?php echo $value->id ?>&com=<?php echo $model->id ?>">
