        ...
        <?php if (!empty($model)): ?>
            <?php foreach ($model as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        <a href="/index.php/trade-company/view?id=<?php echo $value->id ?>" id="delete-services" class="glyphicon glyphicon-cog"></a>
                        ...
                        <a href="/index.php/trade-company/delete?id=<?php echo $value->id ?>" class="glyphicon glyphicon-trash delete-services"></a>
                    </td>
                </tr>
            <?php endforeach ?>
        <?php else: ?>
...
<script>
    ...
    $(function(){
        ...
        $('select').change('select2:select', function (e) {
            ...
            $.ajax({
                url: '/index.php/trade-company/order',
                dataType: 'json',
                type: 'GET',
                data: {
                    id: id,
    ...
    $(document).on('click','#open-modal-services',function(){
        $.ajax({
            url: '/index.php/trade-company/create',
            dataType: 'json',
            type: 'GET',
            success: function (response) {
                if (response.status == 'success') {
    ...
    $(document).on('click','.save-services',function(){
        ...
        $.ajax({
            url: '/index.php/trade-company/save-services',
            dataType: 'json',
            type: 'GET',
            data:{
    ...
    $(document).on('click','#update-services',function(){
        ...
        $.ajax({
            url: '/index.php/trade-company/update',
            dataType: 'json',
            type: 'GET',
            data: {id: id},
            success: function (response) {
    ...
    $(document).on('click','.update-save-services',function(){
        ...
        $.ajax({
            url: '/index.php/trade-company/update-save',
            dataType: 'json',
            type: 'GET',
            data:{
                services_uz: services_uz,
