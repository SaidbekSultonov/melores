...
<div class="company-files-form">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?php 
                $categories = TradeServices::findAll(['type' => 1]);
                $listData=ArrayHelper::map($categories,'id', 'title_uz');
                echo $form->field($model, 'services_type_id')->dropDownList($listData, ['prompt'=>'Kategoriya tanlang']);
            ?>
            <?= 
        ...
        <div class="col-md-6">
            ...
            <?php
                $categories = TradeDistrict::find()->all();
                $listData=ArrayHelper::map($categories,'id', 'title_uz');
...
<script>
    $(function(){
        ...
        $(document).on('change','#tradecompanyfiles-type',function(){
            let type = $(this).val()
